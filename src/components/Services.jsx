  ...
  return (
    ...
    ">
     ...
     <article className="w-full h-full text-left py-14 px-14 items-center justify-center gap-6 flex flex-col  justify-items-start">
       ...
       <p className="text-[#9b9292] text-[20px] dark:text-white">This year, our new summer colletion will shelter you from the harsh element of a world that doesnt care if you live or die.</p>
    ...
    <article className="w-full h-full flex justify-around justify-items-center pb-6 dark:bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhkiY9ssmcY0FbQ4IvAnGzwDMY3GysHaNJQw3uNTj_R2rE44-PKkBIcto16W1MqB1BXmk&usqp=CAU')]">
